        # Component Nma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/component-nma.git

        ## Objective

        ComponentNMA implements the world-first browser-based component network meta-analysis with interaction terms and random-effects models, enabling decomposition of complex interventions.
        ...
        - Code: https://github.com/mahmood726-cyber/component-nma.git
        - Dashboard: https://mahmood726-cyber.github.io/component-nma/
